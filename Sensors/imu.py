...
#This is the simplified IMU code. The main function shows how to send data requests. Built for the TyphoonII Spartion G6 IMU-JG
...
if __name__ == "__main__":
    #This code calls for the pitch according to the TyphoonII IMU
    print("Main run!")
    print(get_pitch())
    time.sleep(5)
    print(get_pitch())
